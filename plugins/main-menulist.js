...
const sections = [
{
 title: `${htki} 𝑆𝑃𝐸𝐸𝐷 𝐵𝑂𝑇 ${htka}`,
   ...
   {title: `${emot} 𝑁𝑂 𝐶𝐴𝑇𝐸𝐺𝑂𝑅𝑌`, rowId: ".? nocategory", description: "𝐹𝐼𝑇𝑈𝑅 𝑇𝐴𝑁𝑃𝐴 𝐾𝐴𝑇𝐸𝐺𝑂𝑅𝑌!"},
        ...
        title: `${htki} 𝑆𝑈𝐵𝐶𝑅𝐼𝐵𝐸 𝑌𝑇 𝘏𝘈𝘗𝘗𝘠𝘉𝘖𝘠-𝑀𝐷 ${htka}`,
        rows: [
   {title: `${emot} 𝑆𝑈𝐵𝐶𝑅𝐼𝐵𝐸 𝑌𝑇 𝘏𝘈𝘗𝘗𝘠𝘉𝘖𝘠-𝑀𝐷`, rowId: "kosg", description: "𝑆𝑈𝐵𝐶𝑅𝐼𝐵𝐸 𝐶𝐴𝑁𝑁𝐸𝐿 𝘏𝘈𝘗𝘗𝘠𝘉𝘖𝘛-𝑀𝐷🌝"},
        ]
        },
]
...
├━━━━━━━━━━━━━━━━┈─⋆
│
│ ▸ *Sumber :* YouTube Happy-MD Official
│ ▸ *ᴀᴜᴛʜᴏʀ :* 𝘏𝘈𝘗𝘗𝘠 𝘉𝘖𝘛
┴ ▸ *ᴏᴡɴᴇʀ :* ${nameown}
✧
┬ 📌 𝗣𝗶𝗻𝗻𝗲𝗱 :
